...
const meta: Meta<LableValiSelectComponent> = {
  title: 'Forms/Validation/Label Select Validation',
  component: LableValiSelectComponent,
  tags: ['autodocs'],
  argTypes: {
...
export default meta;
type Story = StoryObj<LableValiSelectComponent>;
